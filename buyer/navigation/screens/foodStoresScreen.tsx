...
import { FoodStoresAction } from '../../redux/actions/FoodStoresAction';
...
const FoodStores = (props:Props) => {
    ...
    useEffect(() => {
        ...
        {
            setLoading(true);
            Dispatch(FoodStoresAction(null));
            load();
        }
        else
        {
...
return (
    <View style={style.view}>
          {(foodStores && ((JSON.stringify(foodStores.Open)  !== JSON.stringify([])) || JSON.stringify(foodStores.Closed) !== JSON.stringify([]))) &&  <Text style={style.title}>Enjoy The Best Food .</Text>}
           { (foodStores && ((JSON.stringify(foodStores.Open)  !== JSON.stringify([])) || JSON.stringify(foodStores.Closed) !== JSON.stringify([])))  ? <ScrollView>
             <StoresGrid title='New On HomeDelivery' displayStores={foodStores?.Open} />
             <StoresGrid title='Closed Stores' displayStores={foodStores?.Closed} />
